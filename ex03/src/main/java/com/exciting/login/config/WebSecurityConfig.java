...
=======
			...
			.mvcMatchers("/mypage/getMember","/mypage/upload").hasAnyRole("user","admin")
			.mvcMatchers("/board/**","/customer/**").permitAll()
			.mvcMatchers("/selectedapi/**","/customer/**").permitAll()
			.mvcMatchers("/promotion/**").permitAll()
			.mvcMatchers("/promotionprice/**").permitAll()
			.mvcMatchers("/order/**","/order").permitAll()
			.mvcMatchers("/mypoint/**").permitAll()
			.mvcMatchers("/orderlist/**").permitAll()
			.mvcMatchers("/check/**").permitAll()
			.mvcMatchers("/refund/**").permitAll()
