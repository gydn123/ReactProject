              ...
              <Form.Group controlId="floatingInput" className="mb-3">
                <InputGroup>
                  <FormControl
                    type="search"
                    name="searchName"
                    placeholder="놀이공원을 찾아볼까요?"
                    onChange={onChangeListData}
                  />
                </InputGroup>
              </Form.Group>
            </Col>
              ...
              >
                {[
                  ...
                  <React.Fragment key={item.id}>
                    ...
                    />
                    <label
                      className="btn btn-outline-primary index-radio px-4"
                      htmlFor={item.id}
                    >
                      {item.label}
                    </label>
              ...
              >
                {[
                  ...
                  <React.Fragment key={item.id}>
                    ...
                    />
                    <label
                      className="btn btn-outline-secondary index-radio"
                      htmlFor={item.id}
                    >
                      {item.label}
                    </label>
