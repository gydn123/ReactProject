...
function ElasticBoard() {
              ...
              return (
                <tr key={hit._id}>
                  ...
                  <td style={{ textAlign: "center", padding: "0 0 0 10px" }}>
                    <a href={"/board/view?board_id=" + hit._id}>
                      {hit._source.b_title}
                    </a>
                  </td>
                  <td>{member_id}</td>
  ...
  const paging = (pagevalue, currentPage, pageSize) => {
    ...
    if (first > 10) {
      return (
        <button class="pagination-button" value=" + (prev) + ">
          Prev
        </button>
      );
    }
    for (let j = first; j <= last; j++) {
      if (currentPage === j) {
        return (
          <button className="pagination-button" value=" + (j) + ">
            {" "}
            {j}{" "}
          </button>
        );
    ...
    if (next > 10 && next < lowpage) {
      return (
        <button className="pagination-button" value=" + (next) + ">
          {" "}
          next{" "}
        </button>
      );
        ...
        <div id="board-list" style={{ clear: "both" }}>
          ...
          <div className="container">
            <div className="write_from_wrap">
              ...
              <div>
                <ul className="tabs">
                  <li className="tab-link current" id="li-0">
                    <a href="/board/board?b_type=0">전체</a>
                  </li>
                  <li className="tab-link" id="li-1">
                    <a href="/board/board?b_type=1">국내</a>
                  </li>
                  <li className="tab-link" id="li-2">
                    <a href="/board/board?b_type=2">해외</a>
                  </li>
                  <li className="tab-link" id="li-3">
                    <a href="/board/board?b_type=3">질문</a>
                  </li>
                  <li className="tab-link" id="li-4">
                    <a href="/board/board?b_type=4">잡담</a>
                  </li>
                </ul>
              </div>
            ...
            <div className="menu_select">
              <div className="text">
                ...
                >
                  ...
                  <option id="select-1" value="10">
                    10
                  </option>
                  <option id="select-2" value="30">
                    30
                  </option>
                  <option id="select-3" value="50">
                    50
                  </option>
                </select>
              </div>
          ...
          <div className="container">
            <div className="search-window">
              <div className="search-wrap">
                ...
                <input id="text" type="search" name="search" value="" />
                <button
                  type="button"
                  id="searchButton"
